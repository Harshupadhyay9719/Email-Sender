...
var Slider = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    const isKeyboardInteractionRef = React8.useRef(false);
...
function SliderThumbProvider(props) {
  ...
  return (0, import_jsx_runtime4.jsx)(SliderThumbContextProvider, { scope: __scopeSlider, ...thumbContext, children: isFunction2(internal_do_not_use_render) ? internal_do_not_use_render(thumbContext) : children });
}
SliderThumbProvider.displayName = THUMB_PROVIDER_NAME;
var THUMB_TRIGGER_NAME = "SliderThumbTrigger";
var SliderThumbTrigger = React8.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime4.jsx)(
      "span",
      {
        ...
        children: (0, import_jsx_runtime4.jsx)(Collection.ItemSlot, { scope: __scopeSlider, children: (0, import_jsx_runtime4.jsx)(
          Primitive.span,
          {
            role: "slider",
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime4.jsx)(
      SliderThumbProvider,
      {
        __scopeSlider,
        name,
        internal_do_not_use_render: ({ index, isFormControl }) => (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
